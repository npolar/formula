      ...
      var valueFromModel = function (field, model) {
        ...
        if (model[field.id] !== undefined) {
          ...
          if (field.type === "object") {
            field.fields.forEach(function(field, index) {
              if (model[field.id][field.id]) {
                field.valueFromModel(model[field.id]);
              }
            }, field);
